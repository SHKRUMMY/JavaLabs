...
public class SecuritiesManagerTest extends BaseSecuritiesTest {
	...
	public void testEquals() { 				//Symmetrical equals and hashcode testing
		...
		Securities equity1 = new EquitySecurities(50d, 2022, 2023, StockTrend.DECREASING, RiskLevel.MEDIUM, "Mercedes", EquitySecuritiesType.SHARES);
		Securities equity2 = new EquitySecurities(50d, 2022, 2023, StockTrend.DECREASING, RiskLevel.MEDIUM, "Mercedes", EquitySecuritiesType.SHARES);
	...
	public void testToString() {
		Assert.assertEquals(true, testStockMarket.getAvailiableSecurities().get(0).toString().contains("Company Name = Tesla"));
	}
